...
namespace LuaPlayer
{
    ...
    int SummonPlayer(lua_State* L, Player* player)
    {
        ...
        float zoneId = sEluna.CHECKVAL<float>(L, 6);
        uint32 delay = sEluna.CHECKVAL<uint32>(L, 7, 0);
    ...
    {
        uint32 muteseconds = sEluna.CHECKVAL<uint32>(L, 1);
    ...
    {
        bool save = sEluna.CHECKVAL<bool>(L, 1, true);
    ...
    {
        uint32 achievementId = sEluna.CHECKVAL<uint32>(L, 1);
    ...
    {
        uint32 map = sEluna.CHECKVAL<uint32>(L, 1);
        uint32 difficulty = sEluna.CHECKVAL<uint32>(L, 2);
    ...
    {
        uint32 flag = sEluna.CHECKVAL<uint32>(L, 1);
    ...
    /*int CanFlyInZone(lua_State* L, Player* player)
    {
        ...
        uint32 zone = sEluna.CHECKVAL<uint32>(L, 1);
    ...
    {
        uint32 value = sEluna.CHECKVAL<uint32>(L, 1);
    ...
    {
        bool teleToEntryPoint = sEluna.CHECKVAL<bool>(L, 1, true);
    ...
    {
        uint8 newDrunkValue = sEluna.CHECKVAL<uint8>(L, 1);
    ...
    {
        int32 amount = sEluna.CHECKVAL<int32>(L, 1);
    ...
    {
        uint32 faction = sEluna.CHECKVAL<uint32>(L, 1);
    ...
    {
        uint8 race = sEluna.CHECKVAL<uint8>(L, 1);
    ...
    {
        uint16 id = sEluna.CHECKVAL<uint16>(L, 1);
        uint16 step = sEluna.CHECKVAL<uint16>(L, 2);
    ...
    {
        uint32 skill = sEluna.CHECKVAL<uint32>(L, 1);
    ...
    {
        int32 pType = sEluna.CHECKVAL<int32>(L, 1);
    ...
    {
        uint16 position = sEluna.CHECKVAL<uint16>(L, 1);
    ...
    {
        bool cost = sEluna.CHECKVAL<bool>(L, 1, true);
        float discountMod = sEluna.CHECKVAL<float>(L, 2);
        bool guildBank = sEluna.CHECKVAL<bool>(L, 3, false);
    ...
    {
        int32 slot = sEluna.CHECKVAL<int32>(L, 1);
    ...
    {
        int32 points = sEluna.CHECKVAL<int32>(L, 1);
        bool inventory = sEluna.CHECKVAL<bool>(L, 2, true);
    ...
    {
        double percent = sEluna.CHECKVAL<double>(L, 1);
        bool inventory = sEluna.CHECKVAL<bool>(L, 2, true);
    ...
    {
        bool isRaid = sEluna.CHECKVAL<bool>(L, 1, true);
    ...
    {
        uint8 rank = sEluna.CHECKVAL<uint8>(L, 1);
    ...
    {
        uint32 talentId = sEluna.CHECKVAL<uint32>(L, 1);
        uint8 spec = sEluna.CHECKVAL<uint8>(L, 2);
    ...
    /*int AddTalent(lua_State* L, Player* player)
    {
        uint32 spellId = sEluna.CHECKVAL<uint32>(L, 1);
        uint8 spec = sEluna.CHECKVAL<uint8>(L, 2);
        bool learning = sEluna.CHECKVAL<bool>(L, 3, true);
    ...
    {
        bool no_cost = sEluna.CHECKVAL<bool>(L, 1, false);
    ...
    {
        uint32 points = sEluna.CHECKVAL<uint32>(L, 1);
    ...
    {
        uint32 faction = sEluna.CHECKVAL<uint32>(L, 1);
        int32 value = sEluna.CHECKVAL<int32>(L, 2);
    ...
    {
        uint32 entry = sEluna.CHECKVAL<uint32>(L, 1);
        bool disabled = sEluna.CHECKVAL<bool>(L, 2, false);
        bool learn_low_rank = sEluna.CHECKVAL<bool>(L, 3, true);
    ...
    {
        int8 count = sEluna.CHECKVAL<int8>(L, 1);
    ...
    {
        uint32 power = sEluna.CHECKVAL<uint32>(L, 1);
        if (power >= MAX_POWERS)
            return 0;
    ...
    int HasQuestForGO(lua_State* L, Player* player)
    {
        ...
        int32 entry = sEluna.CHECKVAL<int32>(L, 1);
    ...
    {
        uint32 entry = sEluna.CHECKVAL<uint32>(L, 1);
        uint32 status = sEluna.CHECKVAL<uint32>(L, 2);
    ...
    {
        uint8 slot = sEluna.CHECKVAL<uint8>(L, 1);
    ...
    /*int SummonPet(lua_State* L, Player* player)
    {
        ...
        uint32 petType = sEluna.CHECKVAL<uint32>(L, 6);
        uint32 despwtime = sEluna.CHECKVAL<uint32>(L, 7);
    ...
    {
        int mode = sEluna.CHECKVAL<int>(L, 1, PET_SAVE_AS_DELETED);
        bool returnreagent = sEluna.CHECKVAL<bool>(L, 1, false);
    ...
    {
        float bonus = sEluna.CHECKVAL<float>(L, 1);
    ...
    {
        uint8 level = sEluna.CHECKVAL<uint8>(L, 1);
    ...
    {
        bool on = sEluna.CHECKVAL<bool>(L, 1, true);
    ...
    int GetItemByPos(lua_State* L, Player* player)
    {
        ...
        */
        uint8 bag = sEluna.CHECKVAL<uint8>(L, 1);
    ...
    {
        int id = sEluna.CHECKVAL<int>(L, 1);
        bool checkinBank = sEluna.CHECKVAL<bool>(L, 2, false);
    ...
    {
        uint32 arenaP = sEluna.CHECKVAL<uint32>(L, 1);
    ...
    {
        uint32 honorP = sEluna.CHECKVAL<uint32>(L, 1);
    ...
    {
        uint32 val = sEluna.CHECKVAL<uint32>(L, 1);
    ...
    {
        uint32 amt = sEluna.CHECKVAL<uint32>(L, 1);
        player->SetMoney(amt);
        return 0;
    }
    ...
    int SetBindPoint(lua_State* L, Player* player)
    {
        ...
        uint32 mapId = sEluna.CHECKVAL<uint32>(L, 4);
        uint32 areaId = sEluna.CHECKVAL<uint32>(L, 5);
    ...
    {
        uint32 step = sEluna.CHECKVAL<uint32>(L, 1);
    ...
    {
        uint32 _skillId = sEluna.CHECKVAL<uint32>(L, 1);
        uint32 _step = sEluna.CHECKVAL<uint32>(L, 2);
        if (_skillId && _step)
        {
    ...
    {
        uint32 itemId = sEluna.CHECKVAL<uint32>(L, 1);
        uint32 count = sEluna.CHECKVAL<uint32>(L, 2, 1);
        bool check_bank = sEluna.CHECKVAL<bool>(L, 3, false);
    ...
    {
        uint32 spellId = sEluna.CHECKVAL<uint32>(L, 1);
        bool update = sEluna.CHECKVAL<bool>(L, 2, true);
    ...
    {
        uint32 category = sEluna.CHECKVAL<uint32>(L, 1);
        bool update = sEluna.CHECKVAL<bool>(L, 2, true);
    ...
    {
        int32 amt = sEluna.CHECKVAL<int32>(L, 1);
    ...
    {
        float percent = sEluna.CHECKVAL<float>(L, 1, 100.0f);
        bool sickness = sEluna.CHECKVAL<bool>(L, 2, false);
    ...
    int GossipSendMenu(lua_State* L, Player* player)
    {
        ...
        if (sender)
        {
            ...
            {
                uint32 menu_id = sEluna.CHECKVAL<uint32>(L, 3);
    ...
    {
        uint32 soundId = sEluna.CHECKVAL<uint32>(L, 1);
    ...
    {
        uint32 pathId = sEluna.CHECKVAL<uint32>(L, 1);
    ...
    {
        bool apply = sEluna.CHECKVAL<bool>(L, 1, true);
    ...
    int GossipSendPOI(lua_State* L, Player* player)
    {
        float x = sEluna.CHECKVAL<float>(L, 1);
        float y = sEluna.CHECKVAL<float>(L, 2);
        uint32 icon = sEluna.CHECKVAL<uint32>(L, 3);
        uint32 flags = sEluna.CHECKVAL<uint32>(L, 4);
        uint32 data = sEluna.CHECKVAL<uint32>(L, 5);
    ...
    {
        uint32 questId = sEluna.CHECKVAL<uint32>(L, 1);
        bool activeAccept = sEluna.CHECKVAL<bool>(L, 2, true);
