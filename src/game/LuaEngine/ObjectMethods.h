...
namespace LuaObject
{
    ...
    {
        uint16 index = sEluna.CHECKVAL<uint16>(L, 1);
    ...
    {
        uint16 index = sEluna.CHECKVAL<uint16>(L, 1);
        uint8 offset = sEluna.CHECKVAL<uint8>(L, 2);
    ...
    {
        uint16 index = sEluna.CHECKVAL<uint16>(L, 1);
        float value = sEluna.CHECKVAL<float>(L, 2);
    ...
    int SetByteValue(lua_State* L, Object* obj)
    {
        uint16 index = sEluna.CHECKVAL<uint16>(L, 1);
        uint8 offset = sEluna.CHECKVAL<uint8>(L, 2);
        uint8 value = sEluna.CHECKVAL<uint8>(L, 3);
    ...
    int SetUInt16Value(lua_State* L, Object* obj)
    {
        uint16 index = sEluna.CHECKVAL<uint16>(L, 1);
        uint8 offset = sEluna.CHECKVAL<uint8>(L, 2);
        uint16 value = sEluna.CHECKVAL<uint16>(L, 3);
    ...
    int SetInt16Value(lua_State* L, Object* obj)
    {
        uint16 index = sEluna.CHECKVAL<uint16>(L, 1);
        uint8 offset = sEluna.CHECKVAL<uint8>(L, 2);
        int16 value = sEluna.CHECKVAL<int16>(L, 3);
    ...
    {
        float size = sEluna.CHECKVAL<float>(L, 1);
